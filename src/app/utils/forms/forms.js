...
export default class Forms {
   ...
   * @param className
   */
  setGroupClass(field, className) {
    this.groupClass[field] = className;
  }
  /**
  ...
  initialAssign(data) {
    Object.keys(data).map((key) => {
      ...
      if (typeof data[key].label !== 'undefined') this.setLabels(key, data[key].label);
      this.setGroupClass(key, data[key].group_class);
